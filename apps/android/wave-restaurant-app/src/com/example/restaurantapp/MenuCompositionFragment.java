...
public class MenuCompositionFragment extends Fragment {
	...
	public List<TabContent> getContent() {
		return ((TabContentHolder)  getActivity()).getContent();
	}
	...
	@Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			*/
	        ...
	        tabHost.addTab(tabHost.newTabSpec("simple").setIndicator("SimpleCeva"),
	                ProposalFragment.class, params);
	        params = new Bundle();
	        params.putInt("id", 2);
	       tabHost.addTab(tabHost.newTabSpec("notthatsimple").setIndicator("SimpleAltcce"),
	               ProposalFragment.class, params);
	       params = new Bundle();
	       tabHost.addTab(tabHost.newTabSpec("imagefragment").setIndicator("", getResources().getDrawable(R.drawable.ic_copy)),
		   ...
		   b_edit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
		        ...
		        if (i<8){
		           ...
		           tabHost.addTab(tabHost.newTabSpec("notthatsimple").setIndicator("AddedTab"),
			               ProposalFragment.class, params);
