...
public interface InvoicesToContactRelations {
  ...
  LazyResponse<Contact>getContact(InvoicesToContact object , Callback<Contact> cb);
  @Relation(name="invoice",type=RelationType.MANY_TO_ONE)
  LazyResponse<Invoice>getInvoice(InvoicesToContact object , Callback<Invoice> cb);
};
