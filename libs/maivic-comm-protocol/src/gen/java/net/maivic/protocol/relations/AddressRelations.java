...
public interface AddressRelations extends RPCUpdateSubscriptionService {
  ...
  LazyResponse<List<Meeting>>getMeetings(Address  o,@SubscriptionCallback Callback<List<Meeting>> cb);
  ...
  LazyResponse<List<Building>>getBuildings(Address object , @SubscriptionCallback Callback<List<Building>> cb);
