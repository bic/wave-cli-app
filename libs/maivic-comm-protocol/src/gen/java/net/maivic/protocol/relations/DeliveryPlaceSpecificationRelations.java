...
public interface DeliveryPlaceSpecificationRelations {
  ...
  LazyResponse<DeliveryPlace>getDeliveryPlace(DeliveryPlaceSpecification object , Callback<DeliveryPlace> cb);
  @Relation(name="building",type=RelationType.MANY_TO_ONE)
  LazyResponse<Building>getBuilding(DeliveryPlaceSpecification object , Callback<Building> cb);
  @Relation(name="location",type=RelationType.MANY_TO_ONE)
  LazyResponse<Location>getLocation(DeliveryPlaceSpecification object , Callback<Location> cb);
  @Relation(name="place_type",type=RelationType.MANY_TO_ONE)
  LazyResponse<PlaceType>getPlaceType(DeliveryPlaceSpecification object , Callback<PlaceType> cb);
};
