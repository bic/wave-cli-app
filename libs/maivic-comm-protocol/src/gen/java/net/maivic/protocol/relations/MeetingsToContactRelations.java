...
public interface MeetingsToContactRelations {
  ...
  LazyResponse<Contact>getContact(MeetingsToContact object , Callback<Contact> cb);
  @Relation(name="meeting",type=RelationType.MANY_TO_ONE)
  LazyResponse<Meeting>getMeeting(MeetingsToContact object , Callback<Meeting> cb);
};
