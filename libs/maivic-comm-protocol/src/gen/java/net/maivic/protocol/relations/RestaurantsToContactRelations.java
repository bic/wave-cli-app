...
public interface RestaurantsToContactRelations {
  ...
  LazyResponse<Contact>getContact(RestaurantsToContact object , Callback<Contact> cb);
  @Relation(name="restaurant",type=RelationType.MANY_TO_ONE)
  LazyResponse<Restaurant>getRestaurant(RestaurantsToContact object , Callback<Restaurant> cb);
};
